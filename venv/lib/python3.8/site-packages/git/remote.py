...
class PushInfo(object):
    ...
    @property
    def old_commit(self):
        return self._old_commit_sha and self._remote.repo_address.commit(self._old_commit_sha) or None
    ...
    def remote_ref(self):
        ...
        if self.remote_ref_string.startswith("refs/tags"):
            return TagReference(self._remote.repo_address, self.remote_ref_string)
        elif self.remote_ref_string.startswith("refs/heads"):
            remote_ref = Reference(self._remote.repo_address, self.remote_ref_string)
            return RemoteReference(self._remote.repo_address, "refs/remotes/%s/%s" % (str(self._remote), remote_ref.name))
        else:
    ...
    def _from_line(cls, remote, line):
        ...
        if flags & cls.DELETED:
            ...
            if from_ref_string == "(delete)":
                ...
                from_ref = Reference.from_path(remote.repo_address, from_ref_string)
